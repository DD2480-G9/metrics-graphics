    ...
    */
    ...
    this.display = function() {
        ...
        for (h = 0; h < args.columns.length; h++) {
            __COVERAGE__['table_this_display'][0] = true;
            ...
            if (args.show_tooltips && this_col.description && mg_jquery_exists()) {
                __COVERAGE__['table_this_display'][1] = true;
                ...
                __COVERAGE__['table_this_display'][2] = true;
            }
        }

        for (h = 0; h < args.columns.length; h++) {
            __COVERAGE__['table_this_display'][3] = true;
            col = colgroup.append('col');
            if (args.columns[h].type === 'number') {
                col.attr('align', 'char').attr('char', '.');
                __COVERAGE__['table_this_display'][4] = true;
            }
            else {
                __COVERAGE__['table_this_display'][5] = true;
            }
        }

        for (var i = 0; i < args.data.length; i++) {
            __COVERAGE__['table_this_display'][6] = true;
            tr = tbody.append('tr');
            for (var j = 0; j < args.columns.length; j++) {
                __COVERAGE__['table_this_display'][7] = true;
                ...
                if (td_type === 'number') {
                    ...
                    if (this_column.hasOwnProperty('value_formatter')) {
                        ...
                        __COVERAGE__['table_this_display'][12] = true;
                    }


                    if (this_column.hasOwnProperty('format')) {
                        __COVERAGE__['table_this_display'][13] = true;
                        ...
                        if (this_column.round) {
                            __COVERAGE__['table_this_display'][14] = true;
                            td_text = Math.round(td_text, this_column.round);
                        }  else {
                            __COVERAGE__['table_this_display'][15] = true;
                        }
                        ...
                        __COVERAGE__['table_this_display'][16] = true;
                    }


                    if (this_column.hasOwnProperty('currency')) {
                        __COVERAGE__['table_this_display'][17] = true;
                        ...
                        __COVERAGE__['table_this_display'][18] = true;
                    }

                }  else {
                    __COVERAGE__['table_this_display'][19] = true;
                }
                ...
                if (td_type === 'title') {
                    __COVERAGE__['table_this_display'][20] = true;
                    ...
                    if (args.columns[j].hasOwnProperty('secondary_accessor')) {
                        __COVERAGE__['table_this_display'][21] = true;
                        td.append('div')
                            .text(args.data[i][args.columns[j].secondary_accessor])
                            .classed("secondary-title", true);
                    } else {
                        __COVERAGE__['table_this_display'][22] = true;
                    }


                } else {
                    __COVERAGE__['table_this_display'][23] = true;
                    td.text(td_text);
                }
            }
        }
